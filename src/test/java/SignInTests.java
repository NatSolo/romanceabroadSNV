...
public class SignInTests extends BaseUI {
    ...
    public void testMainSingIn() {
        ...
        driver.findElement(Locators.TEXT_FIELD_EMAIL_SIGN_IN).sendKeys(Data.emailSignIn);
        driver.findElement(Locators.TEXT_FIELD_PASSWORD_SIGN_IN).sendKeys(Data.passwordSignIn);
